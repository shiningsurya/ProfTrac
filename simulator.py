...
if len(sys.argv) < 3:
    print "Usage: python simulator.py <ROOT> <CHOICE>"
    print "Choice 1 : One component chosen at random goes off"
    print "Choice 2 : One component's variance changes randomly"
    sys.exit(0)
root = sys.argv[1]
...
def ProfWriter(prof,fn,j,mc):
    ...
    if mc:
        fo.write('# {0:.1f} MC PROFILE generated by simulator.py\n'.format(MJD+j))
    else:
        fo.write('# {0:.1f} PROFILE generated by simulator.py\n'.format(MJD+j))
